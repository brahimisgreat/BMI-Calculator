...
import classes from "./bmiLimitations.module.css";

export default function BmiLimitations() {
  return (
    <div className={classes.container}>
      <div className={classes.rec1}>
      ...
      <div className={classes.rec3}>
        <div className={classes.pregnancy}>
          <div className={classes.header}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
